      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_solid_var(--sidebar-gap)_+_2px)]"
...
>(({ className, showIcon = false, ...props }, ref) => {
  // Random width for a more realistic look.
