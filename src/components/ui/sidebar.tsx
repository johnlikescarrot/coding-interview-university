      ...
      >
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+var(--sidebar-gap))]"
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+var(--sidebar-gap)+2px)]"
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:hidden",
        showOnHover &&
          "group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]:opacity-100 md:opacity-0",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "peer-hover/menu-button:text-sidebar-accent-foreground peer-data-[active=true]:text-sidebar-accent-foreground",
      "group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
